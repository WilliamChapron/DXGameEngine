...
void Renderer::CreatePipelineState() {
    ...
    HRESULT hr = CompileShaderFromFile(L"res/shader/ShaderTriangle.hlsl", "VSMain", "vs_5_0", &m_vertexShaderBlob);
    ASSERT_FAILED(hr);
    hr = CompileShaderFromFile(L"res/shader/ShaderTriangle.hlsl", "PSMain", "ps_5_0", &m_pixelShaderBlob);
    ASSERT_FAILED(hr);
